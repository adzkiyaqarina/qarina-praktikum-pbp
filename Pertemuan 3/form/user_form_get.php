    ...
    <div class="container">
        <?php
            if (isset($_GET["submit"])) {
                ...
                if (!empty($_GET['minat'])) { //pake perulangan karena kita bisa milih lebih dari satu, jadi cek dulu minat yang dipilih ada apa engga
            ...
            } //semua hasil submittan dikirimkan melalui URL/dapat dilihat di URL
        ?>
    </div>
</body>
</html>