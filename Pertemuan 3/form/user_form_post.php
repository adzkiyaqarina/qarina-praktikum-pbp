    ...
    <div class="container">
        <?php
            if (isset($_POST["submit"])) { //apakah 
                ...
                if (!empty($_POST['minat'])) { //pake perulangan karena kita bisa milih lebih dari satu, jadi cek dulu minat yang dipilih ada apa engga
            ...
            } //tidak mengirimkan data kita melalui URL
            //perbedaan post dan get, kalo get dikirim lewat url, kalo post
            //gaada yang lebih baik, tergantung penggunaannya. contoh kaya email dan password kan kurang baik kalo keliatan di URL nya makanya bisa pakai post. dan juga kalo ada inputan text yang panjang gaenak kalo pake URL karena ga bakal ketampil semua. tapi kalo sekedar untuk pencarian ga masalah pake get, tapi kalo bersifat rahasia pake post aja.
        ?>
    </div>
</body>
</html>